...
<div id="mainCell">
	...
	<div id="contentAreaCell">
		...
		<div id="mainFrame">
			...
			<div id="mlCell">
			<img src="images/nuestra-piel/img-misc-02.jpg" border="0"><br><br>
<!--			<img src="images/nuestra-piel/img-semianilina.jpg" border="0" style="float:left; margin:0px 10px 10px 0px;">-->
			<p id="titles">Semianilina.</p>
			<p id="txtBody">Usualmente este tipo de pieles son coloreadas con anilina y despu&eacute;s se pigmentan.<br><br>Llevan una capa de color para cubrirlas y protegerlas. Es com&uacute;n que sus superficies sean lisas y presenten cicatrices dependiendo del modelo y acabado.</p>
			</div>
